    ...
    public sealed class FixedWorldArtRuntime : MonoBehaviour
    {
        ...
        private static void ApplyWorldArt()
        {
            ...
            foreach (Renderer renderer in renderers)
            {
                ...
                string texture = ResolveTexture(name);
        ...
        {
            if (ContainsAny(name, "road", "street", "runway", "airstrip", "path")) return "World/road_dust";
            if (ContainsAny(name, "rock", "cliff", "mountain", "boulder", "ridge")) return "World/rock_cliff";
            if (ContainsAny(name, "wall", "building", "house", "fort", "tower", "ruin", "warehouse", "port")) return "World/fortress_wall";
            if (ContainsAny(name, "ground", "terrain", "sand", "dune", "desert", "dryfield", "sunscar")) return "World/sand_ground";
            return null;
        }
        ...
        private static Material GetMaterial(string resourcePath, Material template)
        {
            ...
            Vector2 tiling = resourcePath.Contains("wall") ? new Vector2(3f, 3f) : new Vector2(10f, 10f);
